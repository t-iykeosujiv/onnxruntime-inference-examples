...
def parse_args():
    ...
    parser.add_argument("--profiling", action="store_true", help="Get a memory and runtime profile for an ORT model evaluation")
...
def perf_main(args):
    ...
    for prompt_length in prompt_lengths.keys():
        ...
        prompt_lengths[prompt_length]["prompt cost"] = round(times[1] - prompt_lengths[prompt_length]["per token cost"], 8)
